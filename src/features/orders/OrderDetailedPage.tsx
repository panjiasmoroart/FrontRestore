...
export default function OrderDetailedPage() {
  ...
  // Tanda + (Unary Plus):
  // Berfungsi untuk mengubah string menjadi number.
  // Secara bawaan, useParams() dari React Router selalu mengembalikan nilai dalam bentuk string. Jika API atau fungsi query Anda mengharapkan ID berupa angka, tanda + di depan variabel akan langsung mengonversinya secara cepat

  // Tanda ! (Non-null Assertion Operator)
  // Ini adalah fitur TypeScript untuk memberi tahu compiler: "Percayalah, nilai ini tidak mungkin null atau undefined."
  // Karena id dari useParams() bisa saja bernilai undefined (jika rute tidak cocok), TypeScript akan protes jika Anda memasukkannya ke fungsi yang butuh nilai pasti. Tanda ! menghilangkan peringatan error tersebut
